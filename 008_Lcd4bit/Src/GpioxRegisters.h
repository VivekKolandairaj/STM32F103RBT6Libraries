...
//bit fields of the GPIOb_ODR register
//use the following typedef struct when interfacing 16x2 LCD
//in 4 bit mode
...
typedef struct
{
	...
	uint32_t odr6    :  1;
	uint32_t odr7    :  1;
	uint32_t nibble  :  4; //pins D4, D5, D6, and D7 of LCD
	uint32_t odr12   :  1; //E pin of LCD
	uint32_t odr13   :  1; //RS pin of LCD
	uint32_t odr14   :  1;
	uint32_t odr15   :  1;
	uint32_t reserved: 16;
